...
# Changes in PythOS Indev 2.1.1 Bug Fix 1: Fixed mechanics!
# To add the wait functionality, we need to import time.sleep.
from time import sleep
PythOS_Ver = "Indev 2.1.1 Bug Fix 1"
...
def load():
    ...
    if fname == "Test" and sname == "123":
       ...
       if TryNewDev == "Y":
           print("Just a sec... ")
           sleep(5)
           print("""PythOS has shut down.
You can now download PythOS Developers Edition at:
https://github.com/Captain-Awesome-Jnr/PythOS-Dev-Edition
